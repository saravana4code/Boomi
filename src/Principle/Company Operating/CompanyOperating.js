...
function CompanyOperating() {
  ...
  const EditButtonRenderer = (props) => {
    ...
    const editdata = props.data;
       ...
       const handleEditClick = () => {
        window.location.replace('/CompanyOperatingForm');
  ...
  const columnDefs = [
    ...
    { headerName: 'OperatingEntity', field: 'OperatingEntityCode', sortable: true, filter: true},
    { headerName: 'CompanyCode', field: 'CompanyCode', sortable: true, filter: true},
    ...
    { headerName: 'Currency', field: 'CurrencyCode', sortable: true, filter: true},
    { headerName: 'IsTaxLiable', field: 'IsTaxLiable', sortable: true, filter: true},
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(
        'https://cmk5lnh2s7.execute-api.us-east-1.amazonaws.com/prod/createOperating'
      );
  ...
  return (
    ...
    <div className="company-detail-page">
      ...
      <div className="search-box">
        ...
        <button  onClick={handleRoleType }>ViewGoldenRecord</button>
      </div>
      </div>
...
export default CompanyOperating;
